...
func (c *authClient) Login(ctx context.Context, in *LogingRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
...
func (UnimplementedAuthServer) Login(context.Context, *LogingRequest) (*LoginResponse, error) {
...
func _Auth_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Login(ctx, req.(*LogingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
