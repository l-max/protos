...
func (x *LogingRequest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *LogingRequest) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *LogingRequest) GetAppId() int32 {
	if x != nil {
		return x.AppId
	}
	return 0
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x6e, 0x32, 0xac, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x39, 0x0a, 0x08, 0x52, 0x65,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x31, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x13,
	0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75,
	...
	0x42, 0x16, 0x5a, 0x14, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x73, 0x73, 0x6f, 0x2e,
...
var file_sso_sso_proto_goTypes = []interface{}{
	...
	(*LogingRequest)(nil),    // 2: auth.LogingRequest
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	2, // 1: auth.Auth.Login:input_type -> auth.LogingRequest
